...
class SideNavPurchaser extends StatefulWidget {
  const SideNavPurchaser({Key? key}) : super(key: key);

  @override
  State<SideNavPurchaser> createState() => _SideNavPurchaserState();
}

class _SideNavPurchaserState extends State<SideNavPurchaser> {
                ...
                GestureDetector(
                  onTap: () {
                    FirebaseAuth.instance.signOut().then((value) =>
                        Navigator.of(context).pushNamedAndRemoveUntil(purchaserPath + '/auth', (route) => false));
                  },
                  child: Container(
                    height: 38,
